...
import { USER_FIELDS_FRAGMENT, ORG_FIELDS_FRAGMENT, LOCATION_FIELDS_FRAGMENT, RADIO_FIELDS_FRAGMENT, SERVICE_RECORD_FRAGMENT, RADIO_DETAILS_FRAGMENT, PART_FIELDS_FRAGMENT, TAG_FIELDS_FRAGMENT, BACKUP_ORG_FIELDS_FRAGMENT } from './fragments';
...
export const QUERY_ORGS = gql`
    ${BACKUP_ORG_FIELDS_FRAGMENT}
    query allOrgs {
        allOrgs {
            ... BackupOrgFieldsFragment
        }
    }
`
